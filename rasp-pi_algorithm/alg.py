...
SIG5_SCALE = 1.0
SIG6_SCALE = 1.0
# PE11_SCALE = 1.200760585
# PE12_SCALE = 1.0
# PE13_SCALE = 1.063959706
# PE14_SCALE = 1.156668025
# PE15_SCALE = 1.720125495
# PE16_SCALE = 1.263903112
PE11_SCALE = 1.0
PE12_SCALE = 1.0
PE13_SCALE = 1.0
PE14_SCALE = 1.0
...
class PE():
    ...
    def dc1(self, led=True, dc_mode=2):
        ...
        if dc_mode == 1:
            ...
            if max(self.decision_arr) > self.decision_threshold:
                decision = self.max_ch
